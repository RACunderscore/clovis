# CLOVIS
### C'est un espèce de redis mais vu que je suis français ça fait clovis.

**Objectifs :**
- Avoir un client et un server avec un système d'evenement. CHECK
- Pour inserer, lire, mettre à jour et supprimer des données. CHECK
- Parametrer le format des retours possibles. (Raw, JSON, XML, HTTP) CHECK.
